...
import { RouteBodySchema, ParamIdSchema, RouteQuerySchema } from '../../infrastructure/middlewares/schemas/routeSchemas';
import {authMiddleware} from '../../infrastructure/middlewares/authMiddleware';

const router = Router();
const controller = new RouteController();

router.get('/', authMiddleware, validate(RouteQuerySchema, 'query'), (req, res, next) => controller.findAll(req, res, next));
